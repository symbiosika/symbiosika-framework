...
export default function defineRoutes(app: FastAppHono, API_BASE_PATH: string) {
   ...
   */
  app.get(
    API_BASE_PATH + "/organisation/:organisationId/knowledge/entries",
    authAndSetUsersInfo,
    checkUserPermission,
    describeRoute({
      tags: ["knowledge"],
   ...
   */
  app.get(
    API_BASE_PATH + "/organisation/:organisationId/knowledge/entries/:id",
    authAndSetUsersInfo,
    checkUserPermission,
    describeRoute({
      tags: ["knowledge"],
   ...
   */
  app.post(
    API_BASE_PATH + "/organisation/:organisationId/knowledge/similarity-search",
    authAndSetUsersInfo,
    checkUserPermission,
    describeRoute({
      tags: ["knowledge"],
   ...
   */
  app.post(
    API_BASE_PATH + "/organisation/:organisationId/knowledge/extract-knowledge",
    authAndSetUsersInfo,
    checkUserPermission,
    describeRoute({
      tags: ["knowledge"],
  ...
  app.post(
    API_BASE_PATH +
      "/organisation/:organisationId/knowledge/upload-and-extract",
    authAndSetUsersInfo,
    checkUserPermission,
    describeRoute({
      tags: ["knowledge"],
   ...
   */
  app.post(
    API_BASE_PATH + "/organisation/:organisationId/knowledge/from-text",
    authAndSetUsersInfo,
    checkUserPermission,
    describeRoute({
      tags: ["knowledge"],
   ...
   */
  app.get(
    API_BASE_PATH + "/organisation/:organisationId/knowledge/post-processors",
    authAndSetUsersInfo,
    checkUserPermission,
    describeRoute({
      tags: ["knowledge"],
