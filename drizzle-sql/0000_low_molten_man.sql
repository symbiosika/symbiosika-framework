...
CREATE TABLE "base_organisation_specific_data" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "base_organisation_specific_data_organisation_id_category_unique" UNIQUE("organisation_id","category")
);
--> statement-breakpoint
...
CREATE TABLE "base_knowledge_group" (
	...
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "knowledge_group_name_org_idx" UNIQUE("name","organisation_id")
);
--> statement-breakpoint
...
ALTER TABLE "base_knowledge_text" ADD CONSTRAINT "base_knowledge_text_organisation_id_base_organisations_id_fk" FOREIGN KEY ("organisation_id") REFERENCES "public"."base_organisations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "invitations_email_idx" ON "base_organisation_invitations" USING btree ("email");--> statement-breakpoint
...
CREATE INDEX "organisation_data_version_idx" ON "base_organisation_specific_data" USING btree ("version");--> statement-breakpoint
...
CREATE UNIQUE INDEX "knowledgeentry_name_idx" ON "base_knowledge_entry" USING btree ("name","parentId","organisation_id","team_id","user_id","version");--> statement-breakpoint
...
CREATE INDEX "knowledge_text_organisation_id_idx" ON "base_knowledge_text" USING btree ("organisation_id");--> statement-breakpoint
...
CREATE INDEX "app_logs_organisation_id_idx" ON "base_app_logs" USING btree ("organisation_id");--> statement-breakpoint
CREATE INDEX "webhooks_organisation_id_idx" ON "base_webhooks" USING btree ("organisation_id");--> statement-breakpoint
CREATE UNIQUE INDEX "webhooks_name_organisation_id_idx" ON "base_webhooks" USING btree ("name","webhook_url","organisation_id","event","type");--> statement-breakpoint
...
CREATE INDEX "api_tokens_organisation_id_idx" ON "base_api_tokens" USING btree ("organisation_id");--> statement-breakpoint
